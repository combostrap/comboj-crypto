...
A cipher text of the [protector](src/main/java/com/combostrap/crypto/Protector.java) has the following structure:
...
the [symmetric cipher](src/main/java/com/combostrap/crypto/CryptoSymmetricCipher.java)
...
Check the [tests](src/test/java/com/combostrap/crypto)
